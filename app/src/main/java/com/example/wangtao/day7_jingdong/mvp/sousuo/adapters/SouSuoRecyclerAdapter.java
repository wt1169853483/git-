 ...
 * 作者:wangtao
 */
public class SouSuoRecyclerAdapter extends RecyclerView.Adapter<SouSuoRecyclerAdapter.MyViewHolder>{

    private  List<SousuoBean.DataBean> data1;

    public SouSuoRecyclerAdapter( List<SousuoBean.DataBean> data1) {
        this.data1 = data1;
    }
