 ...
 * 作者:wangtao
 */
public class FeiLeftAdapter extends BaseAdapter{
    private List<FeiLeftBean.DataBean> list;
    private Context context;

    public FeiLeftAdapter(List<FeiLeftBean.DataBean> list, Context context) {
        this.list = list;
