 ...
 * 作者:wangtao
 */
public class WoFlowlayout extends ViewGroup {
    public WoFlowlayout(Context context) {
        super(context);
    }

    public WoFlowlayout(Context context, AttributeSet attrs) {
        super(context, attrs,0);
    }

    public WoFlowlayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightMode = MeasureSpec.getMode(heightMeasureSpec);//测量高的模式
    ...
    //孩子的布局
    public void childViewLayout(View childView, int left, int top, int right, int buttom) {
